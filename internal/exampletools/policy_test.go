...
func TestPolicy(t *testing.T) {
	...
	cases := []struct {
		...
		{"small refund after a pasted tool call", "payments", "refund", refund, []string{"flag:tool_directive"}, receipt.RequireApproval, ""},
		{"small refund after an encoded blob", "payments", "refund", refund, []string{"flag:encoded_blob"}, receipt.RequireApproval, ""},
		{"email after hidden text", "mail", "send", internal, []string{"flag:hidden_text"}, receipt.RequireApproval, ""},
